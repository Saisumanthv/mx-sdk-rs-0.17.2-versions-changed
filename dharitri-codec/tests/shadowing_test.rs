...
// i.e. any types that are in scope and happen to have the same name as dharitri-codec types do not break the build.
...
// Also adding all public functions exposed by dharitri-codec.
...
where
	ST: dharitri_codec::NestedEncode
