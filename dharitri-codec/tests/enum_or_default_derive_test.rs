...
use dharitri_codec::test_util::{check_top_decode, check_top_encode_decode};
...
impl dharitri_codec::EncodeDefault for EnumWithDefault {
	fn is_default(&self) -> bool {
		*self == EnumWithDefault::Basic(0)
	}
}

impl dharitri_codec::DecodeDefault for EnumWithDefault {
	fn default() -> Self {
