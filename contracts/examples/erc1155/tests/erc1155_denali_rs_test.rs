...
fn transfer_fungible_ok_to_sc_test_rs() {
	dharitri_wasm_debug::denali_rs("denali/transfer_fungible_ok_to_sc.scen.json", &contract_map());
}

#[test]
fn transfer_non_fungible_ok_to_sc_test_rs() {
	dharitri_wasm_debug::denali_rs("denali/transfer_non_fungible_ok_to_sc.scen.json", &contract_map());
}


#[test]
fn batch_transfer_fungible_to_sc_test_rs() {
	dharitri_wasm_debug::denali_rs("denali/batch_transfer_fungible_to_sc.scen.json", &contract_map());
}

#[test]
fn batch_transfer_non_fungible_to_sc_test_rs() {
	dharitri_wasm_debug::denali_rs("denali/batch_transfer_non_fungible_to_sc.scen.json", &contract_map());
}

#[test]
fn batch_transfer_both_types_to_sc_test_rs() {
	dharitri_wasm_debug::denali_rs("denali/batch_transfer_both_types_to_sc.scen.json", &contract_map());
}
*/
